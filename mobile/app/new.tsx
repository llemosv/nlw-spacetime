    ...
    >
      ...
      <View className="mt-6 space-y-6">
        <View className="flex-row items-center gap-2">
          ...
          />
          <Text className="fonte-body text-base text-gray-200">
        ...
        <TextInput
          ...
          className="self-end p-0 font-body text-lg text-gray-50"
        ...
        >
          <Text className="text-clack font-alt text-sm uppercase">Salvar</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
